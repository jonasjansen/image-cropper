...
public class DigitProcessFrame extends JFrame {
    ...
    public void start(File baseFolder) {
        ...
        try {
            image1.setImageFolder(
                    ...
                    new File(baseFolder.getPath() + "\\digits\\digit_1\\bilder"),
                    "digit_1",
                    baseFolder.getPath() + "\\digits\\digit_1"
            );
            image2.setImageFolder(
                    new File(baseFolder.getPath() + "\\bilder"),
                    new File(baseFolder.getPath() + "\\digits\\digit_2\\bilder"),
                    "digit_2",
                    baseFolder.getPath() + "\\digits\\digit_2"
            );
            image3.setImageFolder(
                    new File(baseFolder.getPath() + "\\bilder"),
                    new File(baseFolder.getPath() + "\\digits\\digit_3\\bilder"),
                    "digit_3",
                    baseFolder.getPath() + "\\digits\\digit_3"
            );
            image4.setImageFolder(
                    new File(baseFolder.getPath() + "\\bilder"),
                    new File(baseFolder.getPath() + "\\digits\\digit_4\\bilder"),
                    "digit_4",
                    baseFolder.getPath() + "\\digits\\digit_4"
            );
            image5.setImageFolder(
                    new File(baseFolder.getPath() + "\\bilder"),
                    new File(baseFolder.getPath() + "\\digits\\digit_5\\bilder"),
                    "digit_5",
                    baseFolder.getPath() + "\\digits\\digit_5"
            );
        } catch (Exception ex) {
    ...
    private void createLayout() {
        ...
        buttonStatus1.addActionListener(new CheckDigitStatus(
                new File(this.baseFolder.getPath() + "\\digits\\digit_1\\bilder"),
                status1));
        ...
        buttonOpenFolder1.addActionListener(
                new OpenExplorerFolder(new File(baseFolder.getPath() + "\\digits\\digit_1\\bilder"))
        );
        ...
        title2.setText("DIGIT 2");

        // Elements
        JLabel status2 = new JLabel();
        // Can be "Crop Dispay" "Crop Digits" "OK"
        status2.setText("STATUS: Crop Digits");
        ...
        buttonStatus2.addActionListener(new CheckDigitStatus(
                new File(this.baseFolder.getPath() + "\\digits\\digit_2\\bilder"),
                status2));
        ...
        buttonOpenFolder2.addActionListener(
                new OpenExplorerFolder(new File(baseFolder.getPath() + "\\digits\\digit_2\\bilder"))
        );
        ...
        title3.setText("DIGIT 3");

        // Elements
        JLabel status3 = new JLabel();
        // Can be "Crop Dispay" "Crop Digits" "OK"
        status3.setText("STATUS: Crop Digits");
        ...
        buttonStatus3.addActionListener(new CheckDigitStatus(
                new File(this.baseFolder.getPath() + "\\digits\\digit_3\\bilder"),
                status3));
        ...
        buttonOpenFolder3.addActionListener(
                new OpenExplorerFolder(new File(baseFolder.getPath() + "\\digits\\digit_3\\bilder"))
        );
        ...
        title4.setText("DIGIT 4");

        // Elements
        JLabel status4 = new JLabel();
        // Can be "Crop Dispay" "Crop Digits" "OK"
        status4.setText("STATUS: Crop Digits");
        ...
        buttonStatus4.addActionListener(new CheckDigitStatus(
                new File(this.baseFolder.getPath() + "\\digits\\digit_4\\bilder"),
                status4));
        ...
        buttonOpenFolder4.addActionListener(
                new OpenExplorerFolder(new File(baseFolder.getPath() + "\\digits\\digit_4\\bilder"))
        );
        ...
        title5.setText("DIGIT 5");

        // Elements
        JLabel status5 = new JLabel();
        // Can be "Crop Dispay" "Crop Digits" "OK"
        status5.setText("STATUS: Crop Digits");
        ...
        buttonStatus5.addActionListener(new CheckDigitStatus(
                new File(this.baseFolder.getPath() + "\\digits\\digit_5\\bilder"),
                status5));
        ...
        buttonOpenFolder5.addActionListener(
                new OpenExplorerFolder(new File(baseFolder.getPath() + "\\digits\\digit_5\\bilder"))
        );
